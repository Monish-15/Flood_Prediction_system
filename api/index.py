...
# sys.path.insert(0, BASE_DIR) # No longer needed if in same folder or using api prefix

from api.database import init_db, get_db, Prediction
from api.weather   import fetch_weather, weather_description, DEFAULT_LAT, DEFAULT_LON
